            ...
            <div className="md:flex justify-between items-center text-center md:text-left">
                ...
                <div className="flex justify-start items-center md:pt-0 md:pb-0 md:w-1/2">
                    <div className="space-y-5 md:space-y-10 md:w-[500px]">
                        <h1 className="font-extrabold text-[#141B52] text-3xl md:text-[44px] leading-[60px]">
                            US Visitor Visa
                            Appointment in
                            just 30 Days!
                        </h1>
                        ...
                        <div className="md:flex justify-between items-center place-items-center content-center place-content-center grid grid-cols-2 pb-2">
                            <div className="">
                                <div className='flex -space-x-4 mb-2'>
                                    <img className='border-2 border-white rounded-full w-12 h-12' src='https://pagedone.io/asset/uploads/1704275541.png' alt='Stacked rounded avatar' />
                                    <img className='border-2 border-white rounded-full w-12 h-12' src='https://pagedone.io/asset/uploads/1704275541.png' alt='Stacked rounded avatar' />
                                    <img className='border-2 border-white rounded-full w-12 h-12' src='https://pagedone.io/asset/uploads/1704275541.png' alt='Stacked rounded avatar' />
                                </div>

                                <div className="flex items-center gap-1 text-amber-500 transition-all duration-500">
                                    <svg className="w-[18px] h-[18px]" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative flex justify-end pt-10 md:pt-0 md:w-1/2">

                    <img
                        src="/hero.avif"
                        alt="Visa On Time Hero"
                        className="shadow-2xl rounded-[48px] w-[90%] object-contain"
                    />
                </div>
