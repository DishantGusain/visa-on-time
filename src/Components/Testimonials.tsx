    ...
    return <section className="relative px-2 md:px-0 py-10 md:py-16">
        ...
        <div className="md:flex justify-center items-center">
            ...
            <div className="bg-white shadow-gray-300 shadow-xl md:shadow-2xl p-8 rounded-2xl md:w-80 ring-2 ring-slate-100">
                ...
                <p className="font-medium text-base text-gray-500"> Thanks VisaOnTime for making my American dream come true. I had been trying to get US Visitor Visa for a long time without any success.</p>
            </div>
            ...
            <div className="bg-white shadow-gray-300 shadow-xl md:shadow-2xl md:mx-5 my-5 md:my-0 p-8 rounded-2xl md:w-80 ring-2 ring-slate-100">
                ...
                <p className="font-medium text-base text-gray-500">I have been through multiple Visa Consultancy services, no one comes close to this, if you really want to get your US Visa, try VisaOnTime.</p>
            </div>
            ...
            <div className="bg-white shadow-gray-300 shadow-xl md:shadow-2xl p-8 rounded-2xl md:w-80 ring-2 ring-slate-100">
                ...
                <p className="font-medium text-base text-gray-500">My friends are still surprised how I got US Visa before them even after applying late. Kudos to VisaOnTime, Highly Recommended!</p>
            </div>
