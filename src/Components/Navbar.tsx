...
export default function Navbar() {
    ...
    return <div className="">
        <div className="flex justify-between items-center mx-auto pt-6 md:w-[1000px] 2xl:w-[1300px] font-primary text-lg">
        ...
        {open_nav === true ? (
            <div className="  md:hidden pt-6 w-full">
                ...
                <div className="my-4  ml-6 ">
                    <a href="/" className="pb-1  font-medium text-lg hover:text-[#0088ff] transition duration-300 cursor-pointer" >
                        FAQs
