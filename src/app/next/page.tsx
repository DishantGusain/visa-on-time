...
export default function next() {
    ...
    return <div className="desktop:w-[1700px] mx-auto px-5 md:px-8 lg:px-4 lg:w-[980px] 2xl:w-[1250px] ">


        <div className="mt-10 mb-6 lg:my-20">
            <h1 className=" mb-6 font-bold text-[22px] text-center lg:text-2xl desktop:text-4xl">Welcome to VisaOnTime.co US Visa Services!</h1>
            ...
            <div className="font-medium text-base lg:text-lg">
                <div className="bg-textsecondary py-2 px-4 rounded-xl text-white flex  items-center">
                    ...
                    <p className="pl-3 text-xl small:text-[22px] lg:text-2xl desktop:text-3xl font-bold">Read these points carefully about our service before proceeding further.</p>
                </div>
                ...
                <div className="my-6  lg:leading-8">
                    ...
                    <h2 className="font-semibold my-3">Filling the DS160 and payment of Visa Fees</h2>
                    ...
                    <h2 className="font-semibold mt-2 my-3"> Scheduling appointment dates for (a)Fingerprint & (b) Interview</h2>
                    <div className="">
                ...
                <div className="my-6  lg:leading-8">
                    ...
                    <p className="pl-2 lg:pl-6 my-3">
                        - You need to provide us with your Username, Password & Security Question-Answers for usvisascheduling.com account for booking the appointment slot. </p>
                    <p className="pl-2 lg:pl-6 my-3"> 
            ...
            <h1 className=" mb-6 font-bold text-base text-center lg:text-base">Tap PROCEED below to move further, Happy USA Journey:)</h1>

            <div className="flex justify-center items-center">
                <a href="/form" className=" flex justify-center items-center w-[300px] bg-[#EB560D] py-3 shadow shadow-orange-500  rounded-lg font-semibold text-center text-base small:text-lg text-white ">
                    Proceed
                </a>
            </div>
