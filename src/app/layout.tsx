...
export const metadata: Metadata = {
   title: "USA Visa in just 30 Days! - Apply Today",
   description:
      "Get US Visa in just 30 Days. The #1 Visa Agency, successfully assisting US Visa aspirants since 2020. Apply your US Visa today!",
